...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"common/mapper/account-list.mapper.js":[function(require,module,exports) {
"use strict";
...
var mapAccountListFromApiToViewModel = function mapAccountListFromApiToViewModel(accountList) {
  return accountList.map(function (account) {
    return mapAccountFromApiToViewModel(account);
  });
};

exports.mapAccountListFromApiToViewModel = mapAccountListFromApiToViewModel;
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"common/api/account-list.api.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../node_modules/axios/index.js"}],"pages/transfer/transfer.helpers.js":[function(require,module,exports) {
"use strict";
...
var setAccountOptions = function setAccountOptions(accounts, selectedId) {
...
},{}],"../node_modules/@lemoncode/fonk-is-number-validator/dist/@lemoncode/fonk-is-number-validator.esm.js":[function(require,module,exports) {
"use strict";
...
},{}],"../node_modules/@lemoncode/fonk-min-number-validator/dist/@lemoncode/fonk-min-number-validator.esm.js":[function(require,module,exports) {
"use strict";
...
exports.minNumber = validator$1;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"pages/transfer/transfer.custom.validation.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.dateValidator = exports.setErrorMessage = void 0;

var _fonk = require("@lemoncode/fonk");

var validatorType = 'MY_DATE_VALIDATOR';
var defaultMessage = 'La fecha no tiene un formato correcto.';
...
var isValidDate = function isValidDate(value) {
  ...
  if (day > 29 && month === 2) {
    ...
    //console.log('KO 2');
    return false;
  } else if (year > 0 && year === new Date().getFullYear() && month > 0 && month < 13 && day > 0 && day < 32) {
    //console.log('OK');
    return true;
  }
};

var dateValidator = function dateValidator(fieldValidatorArgs) {
  var value = fieldValidatorArgs.value,
      _fieldValidatorArgs$m = fieldValidatorArgs.message,
      message = _fieldValidatorArgs$m === void 0 ? defaultMessage : _fieldValidatorArgs$m;
  var validationResult = {
    succeeded: false,
    message: (0, _fonk.parseMessageWithCustomArgs)(message)
  };
  console.log(value);
...
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js"}],"pages/transfer/transfer.validation.js":[function(require,module,exports) {
"use strict";
...
var _fonkMinNumberValidator = require("@lemoncode/fonk-min-number-validator");

var _transferCustom = require("./transfer.custom.validation");
...
var validationSchema = {
  field: {
    ...
    amount: [{
      validator: _fonkMinNumberValidator.minNumber.validator,
      customArgs: {
        minValue: 0,
        inclusive: false
      },
      ...
      validator: _fonkIsNumberValidator.isNumber.validator,
    ...
    date: [{
      validator: _transferCustom.dateValidator
    }]
  }
};
var formValidation = (0, _fonk.createFormValidation)(validationSchema);
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-iban-validator":"../node_modules/@lemoncode/fonk-iban-validator/dist/@lemoncode/fonk-iban-validator.esm.js","@lemoncode/fonk-is-number-validator":"../node_modules/@lemoncode/fonk-is-number-validator/dist/@lemoncode/fonk-is-number-validator.esm.js","@lemoncode/fonk-min-number-validator":"../node_modules/@lemoncode/fonk-min-number-validator/dist/@lemoncode/fonk-min-number-validator.esm.js","./transfer.custom.validation":"pages/transfer/transfer.custom.validation.js"}],"pages/transfer/transfer.api.js":[function(require,module,exports) {
"use strict";
...
var _accountList = require("../../common/mapper/account-list.mapper");

var _accountList2 = require("../../common/api/account-list.api");

var _transfer = require("./transfer.helpers");

var _transfer2 = require("./transfer.validation");
...
(0, _accountList2.getAccountList)().then(function (accountList) {
  var accountListTransfer = (0, _accountList.mapAccountListFromApiToViewModel)(accountList);
  (0, _transfer.setAccountOptions)(accountListTransfer, params.id);
});
var today = new Date();
...
var transfer = {
  ...
  // Si la fecha está vacía, coge la fecha actual
  email: ''
};
...
(0, _helpers.onUpdateField)('iban', function (event) {
  ...
  _transfer2.formValidation.validateField('iban', transfer.iban).then(function (result) {
...
(0, _helpers.onUpdateField)('name', function (event) {
  ...
  _transfer2.formValidation.validateField('name', transfer.name).then(function (result) {
    (0, _helpers.onSetError)('name', result);
  });
});
(0, _helpers.onUpdateField)('amount', function (event) {
  var value = event.target.value;
  transfer = _objectSpread(_objectSpread({}, transfer), {}, {
    amount: value
  });

  _transfer2.formValidation.validateField('amount', transfer.amount).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _transfer2.formValidation.validateField('email', transfer.email).then(function (result) {
    (0, _helpers.onSetError)('email', result);
  });
});
(0, _helpers.onSubmitForm)('transfer-button', function () {
  _transfer2.formValidation.validateForm(transfer).then(function (result) {
    (0, _helpers.onSetFormErrors)(result);

    if (result.succeeded) {
      (0, _transfer3.insertTransfer)(transfer).then(function (apiTransfer) {
        _router.history.back();
      });
    }
  });
});
},{"../../common/helpers":"common/helpers/index.js","../../core/router":"core/router/index.js","../../common/mapper/account-list.mapper":"common/mapper/account-list.mapper.js","../../common/api/account-list.api":"common/api/account-list.api.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","./transfer.validation":"pages/transfer/transfer.validation.js","./transfer.api":"pages/transfer/transfer.api.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","pages/transfer/transfer.js"], null)
//# sourceMappingURL=/transfer.fe7ce288.js.map