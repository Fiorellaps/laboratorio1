...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"pages/movements/movements.api.js":[function(require,module,exports) {
"use strict";
...
exports.addMovementRows = void 0;

var getMovementRow = function getMovementRow(movement) {
  var transactionCell = document.createElement('td');
  transactionCell.textContent = movement.transaction;
  var realTransactionCell = document.createElement('td');
  ...
  var amount = parseInt(movement.amount);
  ...
  var balance = parseInt(movement.balance);
...
var addMovementRows = function addMovementRows(movementList) {
  movementList.forEach(function (movement) {
    var row = getMovementRow(movement);
    var listElement = document.getElementById('movement-list');
    listElement.appendChild(row);
  });
};

exports.addMovementRows = addMovementRows;
},{}],"pages/movements/movements.mapper.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapMovementsFromApiToViewModel = void 0;
...
var mapMovementsFromApiToViewModel = function mapMovementsFromApiToViewModel(movements) {
  return movements.map(function (movement) {
    return mapMovemetFromApiToViewModel(movement);
  });
};

exports.mapMovementsFromApiToViewModel = mapMovementsFromApiToViewModel;

var mapMovemetFromApiToViewModel = function mapMovemetFromApiToViewModel(movement) {
...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"common/mapper/account.mapper.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapAccountFromViewModelToModel = exports.mapAccountFromApiToViewModel = void 0;
...
var mapAccountFromViewModelToModel = function mapAccountFromViewModelToModel(account) {
  return _objectSpread(_objectSpread({}, account), {}, {
    name: account.alias
  });
};

exports.mapAccountFromViewModelToModel = mapAccountFromViewModelToModel;
},{}],"common/api/account.api.js":[function(require,module,exports) {
"use strict";
...
var _movements3 = require("./movements.mapper");

var _helpers = require("../../common/helpers");

var _router = require("../../core/router");

var _account = require("../../common/mapper/account.mapper");

var _account2 = require("../../common/api/account.api");
...
(0, _account2.getAccount)(params.id).then(function (apiAccount) {
  account = (0, _account.mapAccountFromApiToViewModel)(apiAccount);
  console.log(account);
  (0, _helpers.onSetValues)(account);
});
(0, _movements.getMovements)().then(function (movements) {
  //console.log(movements);
  var viewModelMovements = (0, _movements3.mapMovementsFromApiToViewModel)(movements).filter(function (movement) {
    return movement.accountId == params.id;
  });
  (0, _movements2.addMovementRows)(viewModelMovements);
});
},{"./movements.api":"pages/movements/movements.api.js","./movements.helpers":"pages/movements/movements.helpers.js","./movements.mapper":"pages/movements/movements.mapper.js","../../common/helpers":"common/helpers/index.js","../../core/router":"core/router/index.js","../../common/mapper/account.mapper":"common/mapper/account.mapper.js","../../common/api/account.api":"common/api/account.api.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","pages/movements/movements.js"], null)
//# sourceMappingURL=/movements.9376e031.js.map