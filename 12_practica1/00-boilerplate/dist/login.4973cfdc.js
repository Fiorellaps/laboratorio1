...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"pages/login/login.api.js":[function(require,module,exports) {
"use strict";
...
},{}],"pages/login/login.validation.js":[function(require,module,exports) {
"use strict";
...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/login/login.js":[function(require,module,exports) {
"use strict";

var _helpers = require("../../common/helpers");

var _login = require("./login.api");

var _login2 = require("./login.validation");
...
var onNavigate = function onNavigate(isValid) {
  if (isValid) {
...
(0, _helpers.onUpdateField)('user', function (event) {
  ...
  _login2.formValidation.validateField('user', login.user).then(function (result) {
...
(0, _helpers.onUpdateField)('password', function (event) {
  ...
  _login2.formValidation.validateField('password', login.password).then(function (result) {
    (0, _helpers.onSetError)('password', result);
  });
});
(0, _helpers.onSubmitForm)('login-button', function () {
  _login2.formValidation.validateForm(login).then(function (result) {
...
},{"../../common/helpers":"common/helpers/index.js","./login.api":"pages/login/login.api.js","./login.validation":"pages/login/login.validation.js","../../core/router":"core/router/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","pages/login/login.js"], null)
//# sourceMappingURL=/login.4973cfdc.js.map