...
},{"./routes":"core/router/routes.js","./history":"core/router/history.js"}],"pages/account-list/account-list.helpers.js":[function(require,module,exports) {
"use strict";
...
var getOptions = function getOptions(id) {
  ...
  transferOption.value = _router.routes.transfer(id);
  var movementOption = document.createElement('option');
...
var getAccountRow = function getAccountRow(account) {
  var ibanAnchor = document.createElement('a');
  ibanAnchor.href = _router.routes.account(account.id);
  ibanAnchor.textContent = account.iban;
  var ibanCell = document.createElement('td');
  ...
  var lastTransactionCell = document.createElement('td');
...
var addAccountRows = function addAccountRows(accountList) {
  accountList.forEach(function (account) {
    var row = getAccountRow(account);
    var listElement = document.getElementById('account-list');
    listElement.appendChild(row);
  });
};

exports.addAccountRows = addAccountRows;
},{"../../core/router":"core/router/index.js"}],"common/mapper/account-list.mapper.js":[function(require,module,exports) {
"use strict";
...
var _accountList = require("../../common/api/account-list.api");

var _accountList2 = require("./account-list.helpers");

var _accountList3 = require("../../common/mapper/account-list.mapper");
...
(0, _accountList.getAccountList)().then(function (accountList) {
  ...
  accountList = (0, _accountList2.addAccountRows)(viewModelAccountList);
...
// 1:15 h
},{"../../common/api/account-list.api":"common/api/account-list.api.js","./account-list.helpers":"pages/account-list/account-list.helpers.js","../../common/mapper/account-list.mapper":"common/mapper/account-list.mapper.js","../../common/helpers":"common/helpers/index.js","../../core/router":"core/router/index.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
